...
Private mode can be combined with verifiable builds. The same compiler wrapper,
post-link source-path scrub, and ELF audit run inside/after the container build:
